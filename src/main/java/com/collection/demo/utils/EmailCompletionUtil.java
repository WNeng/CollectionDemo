 ...
 * @date 2019-07-05.
 */
public class EmailCompletionUtil {
     ...
     * **/
    private static final String CHINA_TELECOM_PATTERN = "(?:^(?:\\+86)?1(?:33|49|53|7[347]|8[019]|9[9])\\d{8}$)|(?:^(?:\\+86)?1700\\d{7}$)";

    /**
     * 中国联通号码格式验证 手机段：130,131,132,155,156,185,186,145,176,1707,1708,1709,175
     * **/
    private static final String CHINA_UNICOM_PATTERN = "(?:^(?:\\+86)?1(?:3[0-2]|4[56]|5[56]|6[67]|7[156]|8[56]|9[19])\\d{8}$)|(?:^(?:\\+86)?170[7-9]\\d{7}$)";
    /**
     ...
     *
     **/
    private static final String CHINA_MOBILE_PATTERN = "(?:^(?:\\+86)?1(?:3[4-9]|4[7-8]|5[0-27-9]|7[28]|8[2-478]|9[8])\\d{8}$)|(?:^(?:\\+86)?1705\\d{7}$)";
    ...
    public static boolean isChinaTelecomPhoneNum(String str) {
        return match(CHINA_TELECOM_PATTERN, str.trim());
    }
    ...
    public static boolean isChinaUnicomPhoneNum(String str) {
        return match(CHINA_UNICOM_PATTERN, str.trim());
    }
    ...
    public static boolean isChinaMobilePhoneNum(String str) {
        ...
        return match(CHINA_MOBILE_PATTERN, str.trim());
    }
